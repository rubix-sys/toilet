...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(109983668079237).Name .. " 〢 Prismistixal",
    SubTitle = "discord.gg/dtECHSMA3w",
    TabWidth = 160,
...
local Slider = Tabs.Main:AddSlider("Slider", {
    Title = "Note Milisecond Delay",
    Description = "More = Increase Delay",
    Default = 0,
    Min = -0.4,
    Max = 0.4,
    Rounding = 2,
...
Tabs.Updates:AddButton({
    ...
    Callback = function()
        setclipboard("get trolled bitch")
        Fluent:Notify({Title = "Prismistixal", Content = "Copied!", Duration = 2})
    end
})
